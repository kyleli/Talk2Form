...
urlpatterns = [
    ...
    path('editform/<int:form_template_id>/edit_template_body/', views.edit_template_body, name='edit_template_body'),
    path('editform/<int:form_template_id>/save_template_body/', views.save_template_body, name='save_template_body'),
